...
const TERMS_URL =
  'https://ajar-prune-18d.notion.site/Roast-App-Terms-Of-Service-30799fdd69fc804280bfd3137654cb1e?pvs=73';
const PRIVACY_URL =
  'https://ajar-prune-18d.notion.site/Roast-App-Privacy-Policy-30799fdd69fc80d6841dd5a8f142508b?pvs=73';
...
export default function SettingsScreen() {
  ...
  const [currentLanguage, setCurrentLanguage] =
    React.useState<AppLanguage>(getCurrentAppLanguage());
  ...
  const handleClearHistory = () => {
    Alert.alert(t('settings.alerts.clearHistoryTitle'), t('settings.alerts.clearHistoryBody'), [
          ...
          <View
            ...
            {cardSize.width > 0 && cardSize.height > 0 ? (
              <View
                ...
                <AnimatedGradientRect width={cardSize.width} height={cardSize.height} />
              </View>
            ) : null}
            <View
              style={{
              ...
              <View
                style={{ flexDirection: 'row', alignItems: 'center', gap: AppTheme.spacing.sm }}>
                <View
                  style={{
                    width: 36,
                    height: 36,
                    ...
                    <AndroidDropdownMenu
                      ...
                      <AndroidDropdownMenu.Trigger>
                        <AndroidFilledTonalButton
                          ...
                          colors={{
                            containerColor: '#1FEA580C',
                            contentColor: AppTheme.colors.primary,
                          }}>
                          <AndroidText>{t(`languages.${currentLanguage}`)}</AndroidText>
                        </AndroidFilledTonalButton>
                      </AndroidDropdownMenu.Trigger>
