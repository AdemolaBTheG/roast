...
export default function RoastItemScreen() {
  ...
  const favoriteButtonAnimatedStyle = useAnimatedStyle(() => ({
    backgroundColor: interpolateColor(favoriteProgress.value, [0, 1], ['#F3F4F6', '#FFE9DC']),
        ...
        ? {
            ...
            headerRight: () => (
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                <HeaderIconButton
                  icon="copy-outline"
                  accessibilityLabel={t('item.menu.copyRoast')}
                ...
                <HeaderIconButton
                  ...
                  accessibilityLabel={t('item.menu.shareText')}
                  disabled={!currentVariant}
                  onPress={() => {
                ...
                />
                <HeaderIconButton
                  icon={currentVariant?.isFavorite ? 'heart' : 'heart-outline'}
                  accessibilityLabel={
                    currentVariant?.isFavorite ? t('item.menu.unfavorite') : t('item.menu.favorite')
                  }
                ...
                <HeaderIconButton
                  icon="trash-outline"
                  accessibilityLabel={t('item.menu.deleteRoast')}
                  color="#DC2626"
    ...
    <View style={{ flex: 1 }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
                <Text
                  style={{
                    fontSize: 11,
                    fontWeight: '800',
                    color: burnMeta.color,
                    letterSpacing: 0.5,
                  }}>
                  {burnMeta.label}
                </Text>
                <View
                  style={{ width: 8, height: 8, borderRadius: 4, backgroundColor: burnMeta.color }}
                />
              </View>
            </View>
          </View>
      ...
      <View
        ...
        {Platform.OS === 'ios' && !isIOS26OrNewer ? (
          ...
          <>
            <PressableScale onPress={() => void handleFavoritePress()}>
              <Animated.View
                style={[
                  {
                    width: 52,
